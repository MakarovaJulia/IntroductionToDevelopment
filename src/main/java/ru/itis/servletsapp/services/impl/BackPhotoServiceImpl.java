...
public class BackPhotoServiceImpl implements BackPhotoService {
    ...
    public BackPhotoServiceImpl(FilesRepository filesRepository, UsersRepository usersRepository) {
    ...
    public FileInfo saveFileToStorage(UserDto user, InputStream inputStream, String originalFileName, String contentType, Long size) {
        ...
        try {
            ...
            usersRepository.updateBackPhotoForUser(user.getId(), fileInfo.getId());
        } catch (IOException e) {
